...
/**
 * type float32: always 4 bytes
 * @author: zhanglei
 *  Created at: 2019-04-30
 */
class TypeFloat32 implements Type
{
    private static $ins;
    ...
    public function read(Buffer $buf, $withType = true)
    {
        ...
        switch ($tp) {
            ...
            default:
                ...
                throw new BreezeException('wrong breeze float32 type. type:' . $tp);
        }
    }
